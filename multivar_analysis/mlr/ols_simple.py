...
#         print(f'{highlight_if_significant(metrics['R2'])}{month.ljust(9)} R2: {metrics['R2']:.3f}\tMSE: {metrics['MSE']:.3f}\tMAE: {metrics['MAE']:.3f}\033[0m')
#         # for actual, predicted in zip(metrics['Actual'], metrics['Predicted']):
